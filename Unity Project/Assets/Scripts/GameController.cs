...
namespace SpatialPartitionPattern
{
    public class GameController : MonoBehaviour 
    {
        ...
        float timeNew = 0f, timeOld = 0f, deltaTime;
        void Update() 
        {
            timeOld = timeNew;
            timeNew = Time.timeSinceLevelLoad;
            deltaTime = timeNew - timeOld;
            Debug.Log("Time Values Beginning: " + timeOld.ToString("0.000000") + ", End: " + timeNew.ToString("0.000000") +", Delta: " + deltaTime.ToString("0.000000"));
